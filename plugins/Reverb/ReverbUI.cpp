...
public:
  ...
  ReverbUI() : RayUI(DISTRHO_UI_DEFAULT_WIDTH, DISTRHO_UI_DEFAULT_HEIGHT, UI_REFRESH_RATE, TEXTURE_FILTER_POINT) {
...
protected:
  ...
  void onMainDisplay() override
  {
    ...
    float positionRampInc = GetFrameTime() * (8 - 4 * dspParams[kReverb]);
...
private:
  ...
  DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ReverbUI)
};
